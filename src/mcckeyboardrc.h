 ...
 * @brief 
 */
#ifndef __MCCKEYBOARDRC_H__
#define __MCCKEYBOARDRC_H__
...
#define CMD_LEN 8
class ThreadIf;
class MCCKeyboardRC : public MCCKeyboard {
	public:
		/**
		 * @brief constructor
		 */
		MCCKeyboardRC(MCCKeyboardManager *mgr);
		/**
		 * @brief destructor
		 */
		virtual ~MCCKeyboardRC();
